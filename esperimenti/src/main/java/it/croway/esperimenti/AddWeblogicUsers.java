			...
			try {
				...
				for (Row row : s) {
					...
					connection.invoke(userEditor, "createUser",
							new Object[] { codFis, codFis, "User created programmatically." },
							new String[] { "java.lang.String", "java.lang.String", "java.lang.String" });

					connection.invoke(userEditor, "addMemberToGroup", new Object[] { "Inail_Intermediario", codFis },
							new String[] { "java.lang.String", "java.lang.String" });

					System.out.println("User -> " + codFis + " created successfully");
				}
			} catch (Exception e) {
				e.printStackTrace();
			}
